...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+yh8qdMvLnhE4ZDM1"),
                InlineKeyboardButton("backup ⭕️", url="https://t.me/codexsupport_backup")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/codexsupport_backup'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/+yh8qdMvLnhE4ZDM1')
            ],
            [
                InlineKeyboardButton('🎬 Serching & Movie Club 🎬', url=f'https://t.me/codexrequesting_Movies')
            ]
            ]
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('🎬 Requesting & Movie Club 🎬', url=f'https://t.me/codex_requestingMovies')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/codexsupport_backup'),
            InlineKeyboardButton('Movie Club ⭕️', url='codex_requestingMovies')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/+yh8qdMvLnhE4ZDM1"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/+yh8qdMvLnhE4ZDM1")
    ])
